 ...
 * FIX J. Wuebbelmann
 * Date: 2017 10 17
 * The Chip_IOCON_PinMux requires a mode value in range 0 ... 3 (2 valid bits)
 * in this module, the mode value is of type IOCON_MODE_xxx which is defined as (0..3) << 2
 * as required by the Chip_IOCON_PinMuxSet function. See iocon_17xx_40xx.h line 78 ..81
 * Therefore, we call the Chip_IOCON_PinMuxSet function!
 */
#define Chip_IOCON_PinMux(a, b, c, d, e) Chip_IOCON_PinMuxSet((a), (b), (c), (d) | (e) )
/*
 * EnD of FIX
 */
...
/* --MU, 24.06.2016
 * OLED has chip select at P0.6 (lpcxpresso board).
 * If P0.6 is SSEL (FUNC2) then several devices at SSP1 may interfere (eg. OLED an 7Segment or MMC).
 * SSEL has to implemented separtely by using different GPIO.
...
void Board_I2C_Init(I2C_ID_T id)
{
	...
	case I2C1:
/* --Bugfix MU, 16.06.2016
 * 	https://community.nxp.com/message/768592
