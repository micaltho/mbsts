 ...
 * 
 *
 * File Path	: ../Source/Monitor/Trace/RXF_Monitor.h
 *
...
namespace RXF {
    ...
    public :
        ...
        void sendEventStart(Event* const event);
    
    private :
    
        void sendTimeOut(const WSTMonitorTraceTimeout* const pEventData);
        
        void sendTraceEvent(const WSTMonitorTraceEvent* const pEventData, const std::uint8_t parameterSize, const std::uint8_t* const parameter);
