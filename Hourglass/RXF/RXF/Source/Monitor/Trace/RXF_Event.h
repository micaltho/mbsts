 ...
 * 
 *
 * File Path	: ../Source/Monitor/Trace/RXF_Event.h
 *
...
namespace RXF {
    ...
    public :
        ...
        inline const void* getSource(void) const
        {
            return source;
        }
        
        inline void setSource(void * const p_source)
        {
            source = p_source;
        }
        ...
        // 
        explicit inline Event(const Id_t aId = 0, const bool aDeleteAfterConsume = true) : id(aId), deleteAfterConsume(aDeleteAfterConsume), source(nullptr), size(0U), destination(nullptr)
        {
        }
