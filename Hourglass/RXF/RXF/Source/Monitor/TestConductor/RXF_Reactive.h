 ...
 * 
 *
 * File Path	: ../Source/Monitor/TestConductor/RXF_Reactive.h
 *
...
namespace RXF {
    ...
    public :
        ...
        #define OMReactive RXF::Reactive
        #define IOxfEvent RXF::Event
        #define OMSETPARAMS( EVENT_NAME ) EVENT_NAME* params = static_cast<EVENT_NAME*>(getCurrentEvent()); //Used for TestConductor compatibilty
        // 
        ...
        inline void setCurrentEvent(const Event* const event)
        {
            currentEvent = event;
        }
