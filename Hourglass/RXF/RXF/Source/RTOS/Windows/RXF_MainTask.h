 ...
 * 
 *
 * File Path	: ../Source/RTOS/Windows/RXF_MainTask.h
 *
...
#include "Windows.h"
namespace RXF {
    // This class represents the main task. As there is only one main task, this class is a singleton with only one static instance. Otherwise no main task will be running.
