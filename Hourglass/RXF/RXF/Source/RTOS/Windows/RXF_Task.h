 ...
 * 
 *
 * File Path	: ../Source/RTOS/Windows/RXF_Task.h
 *
...
namespace RXF {
    ...
    private :
        ...
        static unsigned __stdcall entryPoint(void * task);
    ...
    public :
        ...
        inline HANDLE * getTaskHandle(void);
    ...
    inline HANDLE * Task::getTaskHandle(void)
    {
        return &threadHandle;
    }
}
