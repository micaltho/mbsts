 ...
 * 
 *
 * File Path	: ../Source/RTOS/AUTOSAR/RXF_Task.h
 *
...
namespace RXF {
    ...
    private :
        ...
        void deleteTask(void) const;
    
    public :
    
        inline const pthread_t * getTaskHandle(void) const;
        
        // Satisfies requirement 3741: Task - Sleep
        // A Task shall sleep for given time in milli seconds.
        // 
        static void sleep(const std::uint32_t milliSeconds);
        
        void suspend(void) const;
        
        static void suspendHandler(const int_t);
    ...
    inline const pthread_t * Task::getTaskHandle(void) const
    {
        return &taskHandle;
    }
}
