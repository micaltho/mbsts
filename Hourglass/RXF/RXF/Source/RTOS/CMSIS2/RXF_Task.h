 ...
 * 
 *
 * File Path	: ../Source/RTOS/CMSIS2/RXF_Task.h
 *
...
namespace RXF {
    ...
    private :
        ...
        // CMSIS2 thread identifier.
        osThreadId_t taskHandle;
        
        // CMSIS2 thread attribute to store information about the thread to initilze the thread inside operation createTask().
