 ...
 * 
 *
 * File Path	: ../Source/RTOS/OORTX/RXF_MainTask.h
 *
...
namespace RXF {
    ...
    private :
        ...
        // This constructor is private as WST_MTSK is a singleton. It is only called one time, when creating the static instance. It calls the base class constructor with the main task defines and calls startDispatching(). This means the Main Task will start running, as soon the RTOS starts scheduling.
